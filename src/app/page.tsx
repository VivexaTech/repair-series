...
<div className="relative mx-auto w-full max-w-md lg:ml-auto lg:mr-0 animate-[float_4s_ease-in-out_infinite]">
  <div className="relative rounded-3xl border border-white/40 bg-white/90 p-6 shadow-[0_20px_40px_rgba(0,0,0,0.08)] backdrop-blur-[12px] sm:p-8">
    <div className="space-y-6">
      ...
      {/* Mobile Bottom Bar */}
      <div className="fixed bottom-0 left-0 z-[1000] flex w-full items-center justify-between border-t border-black/5 bg-white/85 px-3 py-2 pb-[calc(8px+env(safe-area-inset-bottom,12px))] backdrop-blur-[16px] md:hidden">
        <div>
          <p className="m-0 text-base font-bold text-[#0a0f1c]">Need an Expert?</p>
